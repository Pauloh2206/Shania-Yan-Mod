...
// CORREÇÃO AQUI: Garante que a pasta 'dados/src' exista no backup ANTES de copiar o config.json
...
// [Removido] Backup de dados/src/.scripts/update.js
// [Removido] Backup de dados/src/index.js
...
const filesToClean = [
 ...
 'src/.scripts', // Diretório de scripts (contém update.js)
...
// Garante que a pasta src exista antes de restaurar o config.json
...
// [Removido] Restauração de dados/src/.scripts/update.js
// [Removido] Restauração de dados/src/index.js
...
// 4. APLICAR ATUALIZAÇÃO (Substitui index.js e update.js com a versão do repo)
await applyUpdate();
updateApplied = true;
